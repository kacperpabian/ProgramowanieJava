...
public class AsymmetricCryptography {
    ...
    public void encryptFile(String filename) throws Exception {
        ...
        String encrypted_msg = encryptText(text, privateKey);

        PrintWriter writer = new PrintWriter("encryptedMsg.txt", "UTF-8");
        writer.println(encrypted_msg);
        writer.close();
    ...
    public void decryptFile(String filename) throws Exception {
        ...
        String decrypted_msg = decryptText(text, publicKey);

        PrintWriter writer = new PrintWriter("decryptedMsg.txt", "UTF-8");
        writer.println(decrypted_msg);
        writer.close();
    }
